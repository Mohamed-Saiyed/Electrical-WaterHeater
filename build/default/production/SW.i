...
for(index = SW_SET ; index < (3) ; index++ )
{
...
if(index == SW_PLUS)
{
SWs_Info[index].SW_Samples[1] = ((((PORTB)) & (1 << SW_PLUS)) >> (SW_PLUS));
}
else if(index == SW_MINUS)
{
SWs_Info[index].SW_Samples[1] = ((((PORTB)) & (1 << SW_MINUS)) >> (SW_MINUS));
}
else if (index == SW_SET)
{
SWs_Info[index].SW_Samples[1] = ((((PORTB)) & (1 << SW_SET)) >> (SW_SET));
}
else
{
